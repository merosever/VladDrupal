 ...
 */
function dvc_theme_html_head_alter(&$head_elements) {
 ...
 */
function dvc_theme_preprocess_page(&$vars) {
 ...
 */
function dvc_theme_menu_local_tasks(&$variables) {
  $output = '';
 ...
 */
function dvc_theme_preprocess_node(&$variables) {
  $node = $variables['node'];
